...
# ruff: noqa: FBT003  (generated file)
...
class RecordSelector(BaseModel):
    ...
    schema_normalization: SchemaNormalization | None = SchemaNormalization.None_
    parameters: dict[str, Any] | None = Field(None, alias="$parameters")
...
class DeclarativeStream(BaseModel):
    ...
    schema_loader: InlineSchemaLoader | JsonFileSchemaLoader | CustomSchemaLoader | None = Field(
        None,
        description="Component used to retrieve the schema for the current stream.",
        title="Schema Loader",
    )
    transformations: list[AddFields | CustomTransformation | RemoveFields | KeysToLower] | None = (
        Field(
            None,
...
class SessionTokenAuthenticator(BaseModel):
    ...
    decoder: JsonDecoder | XmlDecoder | None = Field(
...
class SimpleRetriever(BaseModel):
    ...
    decoder: JsonDecoder | JsonlDecoder | IterableDecoder | XmlDecoder | None = Field(
        None,
