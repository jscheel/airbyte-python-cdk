...
class HttpRequestMatcher(BaseModel):
    type: Literal["HttpRequestMatcher"]
    url: str = Field(
        ...,
    ...
    request_parameters: Optional[Union[str, Dict[str, str]]] = Field(
        ...
        examples=[{"unit": "day"}, {"sort_by[asc]": "updated_at"}],
        title="Query Parameters",
    )


class CallRateLimit(BaseModel):
    type: Literal["CallRateLimit"]
    limit: int
    interval: str = Field(..., examples=["PT1H", "P1D"])
...
class HttpApiBudget(BaseModel):
    ...
    maximum_attempts_to_acquire: Optional[int] = 100000
    ratelimit_reset_header: Optional[str] = "ratelimit-reset"
    ratelimit_remaining_header: Optional[str] = "ratelimit-remaining"
    ratelimit_hit_status_codes: Optional[List[int]] = Field(
