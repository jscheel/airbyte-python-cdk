...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [{"d": f"{10**100}_100"}],
            {},
        ),  # this case was previously causing OverflowError hence this test
        ("simple_no_match", [{"d": "20220203"}], {}),
        (
            "multiple_match",
            [{"d": "2022-02-03", "e": "2022-02-03"}],
            {"d": "%Y-%m-%d", "e": "%Y-%m-%d"},
        ),
        (
            "multiple_no_match",
        ...
        ("format_3", [{"d": "2022-02-03T12:34:56Z"}], {"d": "%Y-%m-%dT%H:%M:%SZ"}),
        ("format_4 1", [{"d": "2022-02-03T12:34:56.000Z"}], {"d": "%Y-%m-%dT%H:%M:%S.%fZ"}),
        ("format_4 2", [{"d": "2022-02-03T12:34:56.000000Z"}], {"d": "%Y-%m-%dT%H:%M:%S.%fZ"}),
        ("format_5", [{"d": "2022-02-03 12:34:56.123456+00:00"}], {"d": "%Y-%m-%d %H:%M:%S.%f%z"}),
        (
            "format_5 2",
            [{"d": "2022-02-03 12:34:56.123456+02:00"}],
            {"d": "%Y-%m-%d %H:%M:%S.%f%z"},
        ),
        ("format_6", [{"d": "2022-02-03T12:34:56.123456+0000"}], {"d": "%Y-%m-%dT%H:%M:%S.%f%z"}),
        (
            "format_6 2",
            [{"d": "2022-02-03T12:34:56.123456+00:00"}],
            {"d": "%Y-%m-%dT%H:%M:%S.%f%z"},
        ),
        (
            "format_6 3",
            [{"d": "2022-02-03T12:34:56.123456-03:00"}],
            {"d": "%Y-%m-%dT%H:%M:%S.%f%z"},
        ),
        ("format_7", [{"d": "03/02/2022 12:34"}], {"d": "%d/%m/%Y %H:%M"}),
        ("format_8", [{"d": "2022-02"}], {"d": "%Y-%m"}),
        ("format_9", [{"d": "03-02-2022"}], {"d": "%d-%m-%Y"}),
        (
            "limit_down",
            [{"d": "2022-02-03", "x": "2022-02-03"}, {"d": "2022-02-03", "x": "another thing"}],
            {"d": "%Y-%m-%d"},
        ),
        (
            "limit_down all",
            [
                {"d": "2022-02-03", "x": "2022-02-03"},
                {"d": "also another thing", "x": "another thing"},
            ],
            {},
        ),
        ...
        (
            "limit_down different format",
            [{"d": "2022-02-03"}, {"d": "2022-02-03T12:34:56.000000Z"}],
            {},
        ),
