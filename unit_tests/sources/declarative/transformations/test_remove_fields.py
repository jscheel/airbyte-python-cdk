...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            None,
            {"k2": "v"},
            id="remove a field that exists (flat dict), condition = None",
        ),
        pytest.param(
            {"k1": "v", "k2": "v"},
            [["k1"]],
            "",
            {"k2": "v"},
            id="remove a field that exists (flat dict)",
        ),
        pytest.param(
            {"k1": "v", "k2": "v"},
            [["k3"]],
            "",
            {"k1": "v", "k2": "v"},
            id="remove a field that doesn't exist (flat dict)",
        ),
        pytest.param(
            {"k1": "v", "k2": "v"},
            [["k1"], ["k2"]],
            "",
            {},
            id="remove multiple fields that exist (flat dict)",
        ),
        ...
        pytest.param(
            ...
            "",
            {"k1": [None, 2]},
            id="remove field inside array (int index)",
        ),
        pytest.param(
            {"k1": [1, 2]},
            [["k1", "0"]],
            "",
            {"k1": [None, 2]},
            id="remove field inside array (string index)",
        ),
        pytest.param(
        ...
        pytest.param(
            ...
            "",
            {"k1": [0, 1]},
            id="remove array index that doesn't exist (flat)",
        ),
        pytest.param(
            {".": {"k1": [0, 1]}},
            [[".", "k1", 10]],
            "",
            {".": {"k1": [0, 1]}},
            id="remove array index that doesn't exist (nested)",
        ),
        pytest.param(
            {".": {"k2": "v", "k1": "v"}},
            [[".", "k1"]],
            "",
            {".": {"k2": "v"}},
            id="remove nested field that exists",
        ),
        pytest.param(
            {".": {"k2": "v", "k1": "v"}},
            [[".", "k3"]],
            "",
            {".": {"k2": "v", "k1": "v"}},
            id="remove field that doesn't exist (nested)",
        ),
        pytest.param(
            {".": {"k2": "v", "k1": "v"}},
            [[".", "k1"], [".", "k2"]],
            "",
            {".": {}},
            id="remove multiple fields that exist (nested)",
        ),
        pytest.param(
            {".": {"k1": [0, 1]}},
            [[".", "k1", 0]],
        ...
        pytest.param(
            ...
            "{{ True }}",
            {},
            id="remove all field if condition is boolean True",
        ),
        pytest.param(
        ...
        pytest.param(
            {
                ...
                "k2": "some_string",
                "k3": "some_long_string",
                "k4": {"k_nested": 123123, "k_nested2": "v2"},
            },
            [["**"]],
            "{{ property is integer }}",
