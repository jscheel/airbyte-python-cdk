...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            RequestOption(
                field_name="after", inject_into=RequestOptionType.request_parameter, parameters={}
            ),
            RequestOption(
                field_name="before", inject_into=RequestOptionType.request_parameter, parameters={}
            ),
            "custom_start",
            "custom_end",
            StreamSlice(
                cursor_slice={"custom_start": "2024-06-01", "custom_end": "2024-06-02"},
                partition={},
            ),
        ...
        pytest.param(
            ...
            None,
            StreamSlice(
                cursor_slice={"start_time": "2024-06-01", "end_time": "2024-06-02"}, partition={}
            ),
            {"after": "2024-06-01", "before": "2024-06-02"},
        ...
        pytest.param(
            RequestOption(
                field_name="after", inject_into=RequestOptionType.body_data, parameters={}
            ),
            RequestOption(
                field_name="before", inject_into=RequestOptionType.body_data, parameters={}
            ),
            "custom_start",
            "custom_end",
            StreamSlice(
        ...
        pytest.param(
            RequestOption(
                field_name="after", inject_into=RequestOptionType.body_json, parameters={}
            ),
            RequestOption(
                field_name="before", inject_into=RequestOptionType.body_json, parameters={}
            ),
            "custom_start",
            "custom_end",
            StreamSlice(
...
def test_datetime_based_request_options_provider(
    ...
    request_option_type = (
        start_time_option.inject_into if isinstance(start_time_option, RequestOption) else None
    )
    match request_option_type:
        case RequestOptionType.request_parameter:
            actual_request_options = request_options_provider.get_request_params(
                stream_slice=stream_slice
            )
        case RequestOptionType.header:
            actual_request_options = request_options_provider.get_request_headers(
                stream_slice=stream_slice
            )
        case RequestOptionType.body_data:
            actual_request_options = request_options_provider.get_request_body_data(
                stream_slice=stream_slice
            )
        case RequestOptionType.body_json:
            actual_request_options = request_options_provider.get_request_body_json(
                stream_slice=stream_slice
            )
        case _:
